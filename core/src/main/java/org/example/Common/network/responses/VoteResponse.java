...
public class VoteResponse {
    ...
    public VoteResponse(boolean success, String message, String voteId, String voteType, 
                       String targetPlayerId, String initiatorId, String reason, 
                       long startTime, long endTime, Map<String, Boolean> votes, 
                       int yesVotes, int noVotes, int totalVotes, int requiredVotes, boolean isActive) {
        this.success = success;
        this.message = message;
        this.voteId = voteId;
