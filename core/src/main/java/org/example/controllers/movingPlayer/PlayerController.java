    ...
    public void update(float delta) {
        if (isCollapsing) {
            ...
            if (collapseTimer < COLLAPSE_TIME) {
                // انیمیشن غش کردن در حال اجرا
                TextureRegion frame = collapse.getKeyFrame(collapseTimer, false); // استفاده از collapseTimer برای ادامه انیمیشن
                ...
                // بعد از تمام شدن انیمیشن، به حالت معمول بازگشت
                isCollapsing = false;
                collapseTimer = 0f;
                switch (facing) {
