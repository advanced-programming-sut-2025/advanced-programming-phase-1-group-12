...
public enum Cooking {
    ...
    PumpkinPie("Pumpkin Pie Recipe",Map.of("pumkin", 1 , "Wheat Flour", 1, "milk", 1, "Sugar", 1) , "", "Stardrop Saloon", 385, 225),
    ...
    public Cooking findCookingWithName(String recipe) {
        for (Cooking type : Cooking.values()) {
            if (type.getName().equals(recipe)) {
                return type;
            }
        }
        return null;
